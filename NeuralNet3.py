...
checkpoint = ModelCheckpoint("saved_models/bestModelconvolved", monitor='val_accuracy', verbose=1, \
                             save_best_only=True, save_weights_only=False, \
                             mode='auto', save_frequency=1)


model.fit(train_input, train_output, epochs=20, verbose=1, shuffle=True, batch_size=16, validation_data=(test_input, test_output), callbacks=[checkpoint])
